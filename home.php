...
<section class="home">
   ...
   <div class="swiper">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide" style="background: url(../images/bg04.avif); background-size: cover; background-position: center; background-repeat: no-repeat;">
            <div class="content">
               <h3><span>Quần Áo - Giày</span></h3>
               <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime reiciendis, modi placeat sit cumque molestiae.</p>
               <a href="shop.php" class="btn">Xem thêm</a>
            </div>
         </div>  
         <div class="swiper-slide" style="background: url(../images/bg05.avif); background-size: cover; background-position: center; background-repeat: no-repeat;">
            <div class="content">
